...
#define PATH(name)                      "/home/fahad/.config/dwm/dwmblocks/blocks/"name
...
/*      pathu                           pathc                           interval        signal */
	{ PATH("wifi.sh"),              PATH("wifi_button.sh"),         20,             5},
	{ PATH("backlight.sh"),         NULL,                           0,              6},
        { PATH("volume.sh"),            PATH("volume_button.sh"),       0,              2},
        { PATH("sys.sh"),               PATH("sys_button.sh"),          30,             4},
