...
if [ -f /home/fahad/.config/synth-shell/synth-shell-prompt.sh ] && [ -n "$( echo $- | grep i )" ]; then
	source /home/fahad/.config/synth-shell/synth-shell-prompt.sh
fi

##-----------------------------------------------------
## better-ls
if [ -f /home/fahad/.config/synth-shell/better-ls.sh ] && [ -n "$( echo $- | grep i )" ]; then
	source /home/fahad/.config/synth-shell/better-ls.sh
fi

##-----------------------------------------------------
## alias
if [ -f /home/fahad/.config/synth-shell/alias.sh ] && [ -n "$( echo $- | grep i )" ]; then
	source /home/fahad/.config/synth-shell/alias.sh
fi

##-----------------------------------------------------
## better-history
if [ -f /home/fahad/.config/synth-shell/better-history.sh ] && [ -n "$( echo $- | grep i )" ]; then
	source /home/fahad/.config/synth-shell/better-history.sh
fi

##-----------------------------------------------------
## synth-shell-greeter.sh
if [ -f build/synth-shell-greeter.sh ] && [ -n "$( echo $- | grep i )" ]; then
	source build/synth-shell-greeter.sh
fi
